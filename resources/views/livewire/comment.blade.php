<div>
    ...
    <article class="p-4 mb-1 text-base bg-white rounded-lg dark:bg-gray-900
    @auth
        ...
        <footer class="flex justify-between items-center mb-1">
            ...
            <div class="flex items-center">
                <p class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white"><img
                        class="mr-2 size-6 rounded-full" src="{{$comment->user->avatar()}}"
            ...
            <div
                ...
                <!-- Dropdown menu -->
                @if($showOptions)
                <div class="absolute z-10 top-full right-0 mt-1
                    ...
                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-300">
                        ...
                        <li>
                            <button wire:click="$toggle('isEditing')" type="button" class="block w-full text-left py-2 px-4
